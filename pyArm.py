...
def insert_square_as_layer(fig, center_x, center_y, size):
    ...
    fig.add_layout_image(
        dict(
            source=f"data:image/svg+xml;base64,{
                square_svg.encode('utf-8').hex()}",
            x=x0,
            y=y0 + size,
            xref="x",
            yref="y",
...
header_card = dbc.Card([
    dbc.CardBody([
        html.Div([
            # Line 178: Insert this line
            html.Img(src="/assets/logo.png", height="60px",
                     style={"float": "left", "margin-right": "10px"}),
            # Line 179: Modify this line
            html.H1("Робо-рука", className="card-title",
            ...
            dbc.Tabs(
                [
                    dbc.Tab([
                        ...
                        html.P(
                            "Рисуйте используя трекпад или мышь вашего устройства на холсте ниже"),
                        dcc.Graph(
                            id="graph_pic",
                        ...
                        html.Div(id='text_input_container', children=[
                            dbc.Input(
                                id='text_input', placeholder="Введите текст...", type="text")
                            # Initially hidden
                        ], style={'display': 'none'}),
                        html.Br(),
                    ...
                    dbc.Tab([
                        ...
                        html.P(
                            "Load a JSON file and hit Draw Now"),
                        dcc.Upload(
                            id="json_upload",
                            children=[
                                html.A('Drag and Drop JSON File Here')],
        ...
        dbc.Row([
            dbc.Col([
                dbc.Button(id='robot_connect',
                           ...
                           className="mr-1"),
                html.P(
                    "Робот ожидает подключения", id="robot_status"),
                html.Br(),
                html.Hr(),
                dbc.Checklist(
                    options=[
                        {"label": "Использовать слайдер",
                         "value": 1},
                        {"label": "Инициализировать слайдер",
                         "value": 2},
                    ],
                    value=[],
                    id="slider_toggle",
                ...
                dbc.DropdownMenu(
                    ...
                    children=[
                        dbc.DropdownMenuItem(
                            id='COM1', children="COM1"),
                        dbc.DropdownMenuItem(
                            id='COM3', children="COM3"),
                        dbc.DropdownMenuItem(
                            id='COM5', children="COM5"),
                        dbc.DropdownMenuItem(
                            id='MAC', children="MAC"),
                    ],
                    color="dark",
                                ...
                                dbc.Row([
                                    dbc.Col([
                                        ...
                                        dcc.Slider(id="z_adjust",
                                                   ...
                                                   step=.25),
                                        html.P(
                                            id="z_adjust_status", children="Смещение: 0"),
                                        ...
                                        dcc.Slider(id="pressure_factor",
                                                   ...
                                                   step=.1),
                                        html.P(
                                            id="pressure_factor_status", children="Давление: -5"),
...
def adjust_marker(value):
    ...
    if value == 0:
        ...
        if value % 2 == 1:
            ...
            return "Adjust the marker", "Вернуться на изначальную позицию"
        else:
